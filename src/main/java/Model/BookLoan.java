...
public class BookLoan {
    ...
    @JoinColumn(name = "appuser_id", table = "book_loan")
    ...
    public BookLoan(LocalDate loanDate, Book book) {
        this(0, loanDate,loanDate.plus(book.getMaxLoanDays()), book);
        this.loanDate = loanDate;
        this.book = book;
    }
    ...
    public BookLoan(int i, LocalDate loanDate, LocalDate plus, Book book) {
    }
